...
API_ID = "21282969"
API_HASH = "ed2f7f79feb3833d126fc5cb597a4659"
...
async def check(session, bot, user_id):
    try:
        client = Client('::memory::', api_id=21282969, api_hash='ed2f7f79feb3833d126fc5cb597a4659', in_memory=True, session_string=session)
    except Exception as a:
        print(a)
    try:
        await client.start()
